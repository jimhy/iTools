...
const COMMANDS: &[&str] = &[
        ...
        "plugin_camera_list",
        "plugin_camera_grab",
        "plugin_camera_stream_start",
        "plugin_camera_stream_stop",
        "plugin_audio_loopback_start",
        "plugin_audio_loopback_stop",
        "plugin_record_video_start",
        "plugin_record_video_stop",
        "plugin_active_uses",
        "plugin_stop_all_sensitive",
        "plugin_audit_log",
        "plugin_audit_clear",
        "plugin_register_main_push",
        "plugin_main_push_result",
        "search_push",
        "plugin_notify_show",
        "plugin_tray_set",
        "plugin_tray_remove",
        ...
        "plugin_crypto_set",
        "plugin_crypto_get",
        "plugin_crypto_remove",
        "plugin_crypto_keys",
        "plugin_attach_put",
        "plugin_attach_get",
        "plugin_attach_remove",
        "plugin_attach_list",
        "plugin_schedule_add",
        "plugin_schedule_remove",
        "plugin_schedule_list",
        "plugin_zip_create",
        "plugin_unzip",
        "plugin_fs_watch_start",
        "plugin_fs_watch_stop",
        "plugin_get_file_icon",
        "plugin_runtime_list",
        "plugin_runtime_ensure",
        "plugin_runtime_exec",
        "plugin_runtime_exec_stream",
        "plugin_runtime_exec_kill",
        "plugin_runtime_exec_quit",
        "plugin_runtime_remove",
        "plugin_proc_list",
        "plugin_proc_kill",
        "plugin_installed_apps",
        "plugin_startup_list",
        "plugin_startup_remove",
        "plugin_startup_set_enabled",
        "plugin_power_lock",
        "plugin_power_sleep",
        "plugin_power_shutdown",
        "plugin_power_restart",
        "plugin_input_type_string",
        "plugin_input_paste_text",
        "plugin_input_paste_image",
        "plugin_input_paste_file",
        "plugin_input_key_tap",
        "plugin_input_mouse_move",
        "plugin_input_mouse_click",
        "plugin_input_mouse_double_click",
        "plugin_input_mouse_right_click",
        "plugin_clipboard_watch_start",
        "plugin_clipboard_watch_stop",
        "plugin_win_list",
        "plugin_win_get_foreground",
        "plugin_win_focus",
        "plugin_win_move",
        "plugin_win_resize",
        "plugin_win_set_rect",
        ...
        "plugin_sqlite_batch",
        "plugin_sqlite_close",
        "plugin_context_active_window",
        "plugin_context_browser_url",
        "plugin_context_folder_path",
        "plugin_image_resize",
        "plugin_image_crop",
        "plugin_image_convert",
        "plugin_image_compress",
        "plugin_image_info",
        "plugin_screen_cursor_point",
        "plugin_screen_pick_color_at",
        "plugin_screen_to_dip",
        "plugin_screen_to_physical",
        "plugin_screen_rect_to_dip",
        "plugin_screen_rect_to_physical",
        "plugin_sys_info",
        "plugin_sys_usage",
        "plugin_sys_get_path",
        "plugin_show_item_in_folder",
        "plugin_exec",
        "plugin_exec_stream",
        "plugin_exec_kill",
        "plugin_exec_quit",
        "plugin_paths_resolve",
        "plugin_paths_scan",
        "plugin_trash",
        "plugin_pick_dir",
        "plugin_pick_file",
        "plugin_fs_list_scopes",
        "plugin_fs_revoke_scope",
        "plugin_fs_list",
        "plugin_fs_stat",
        "plugin_fs_hash",
        "plugin_fs_read",
        "plugin_fs_read_chunk",
        "plugin_fs_write",
        "plugin_download",
        "plugin_download_cancel",
